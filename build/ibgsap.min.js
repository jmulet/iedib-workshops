...
!function(){"use strict";function e(e,a){try{return JSON.parse(e)}catch(t){return console.error("[gsap-init] JSON inválido en escena:",a,"\n",t.message,"\n","JSON recibido:",e),null}}function a(e,a){return"true"===e.getAttribute(a)}function t(e,a){e.setAttribute("style",g.errorStyle),e.setAttribute("title","[gsap-init error] "+a)}function r(e){return e&&"string"==typeof e?e.replace(/\bgeq\b/g,">=").replace(/\bleq\b/g,"<=").replace(/\bgt\b/g,">").replace(/\blt\b/g,"<").replace(/\bplus\b/g,"+").replace(/\bminus\b/g,"-").replace(/\band\b/g,"&").replace(/\bor\b/g,"|").replace(/\blt(?=\d)/g,"<").replace(/\bgt(?=\d)/g,">").replace(/\bplus(?=\d)/g,"+").replace(/\bminus(?=\d)/g,"-"):e}function n(e,a,t){var s=gsap.timeline();return e.forEach(function(e,i){if(e.subtimeline){if(!Array.isArray(e.subtimeline))return void console.warn("[gsap-init] step["+i+"].subtimeline no es un array",e);var o=n(e.subtimeline,a,t),l=r(void 0!==e.position?e.position:g.defaults.position);return t&&console.log('[gsap-init] subtimeline en posición "'+l+'"'),void s.add(o,l)}if(!e.target)return void console.warn("[gsap-init] step["+i+'] no tiene "target"',e);var d;if(d=Array.isArray(e.target)?e.target.map(function(e){return a.querySelector(r(e))}).filter(Boolean):a.querySelector(r(e.target)),!d||Array.isArray(d)&&0===d.length)return void console.warn('[gsap-init] target "'+e.target+'" no encontrado en',a);var c=e.from||{},u={},p=e.to||{};for(var v in p)u[v]=p[v];var l=r(void 0!==e.position?e.position:g.defaults.position);u.duration=void 0!==e.duration?e.duration:g.defaults.duration,u.ease=void 0!==e.ease?e.ease:g.defaults.ease,void 0!==e.stagger&&(u.stagger=e.stagger),void 0!==e.repeat&&(u.repeat=e.repeat),void 0!==e.yoyo&&(u.yoyo=e.yoyo),t&&console.log("[gsap-init] step["+i+'] target="'+e.target+'"',"from:",c,"to:",u,"position:",l),Object.keys(c).length>0?s.fromTo(d,c,u,l):s.to(d,u,l)}),s}function s(s){var i=a(s,g.debugAttr)||null!==s.closest("[data-gsap-debug='true']"),o=s.querySelector("[data-gsap-timeline]");o?"TEMPLATE"!==o.tagName&&(o.style.display="none"):i&&console.log("[gsap-init] escena sin timeline:",s);var l=o?"TEMPLATE"===o.tagName?o.innerHTML:o.textContent:"[]",d=l.replace(/<br\s*\/?>/gi," ").replace(/[\r\n]+/g," ").trim(),c=e(d,s);if(null===c)return void t(s,"JSON inválido en <template data-gsap-timeline>");if(!Array.isArray(c))return t(s,"El JSON debe ser un array [ ... ]"),void console.error("[gsap-init] El JSON debe ser un array. Recibido:",c);var u=n(c,s,i),p=s.getAttribute("data-gsap-start"),v=s.getAttribute("data-gsap-end"),f={animation:u,trigger:s,start:r(null!==p?p:g.defaults.start),end:r(null!==v?v:g.defaults.end),scrub:a(s,"data-gsap-scrub")||g.defaults.scrub,pin:a(s,"data-gsap-pin")||g.defaults.pin,markers:a(s,"data-gsap-markers")||i,anticipatePin:1},b=s.getAttribute("data-gsap-scrub");b&&"true"!==b&&"false"!==b&&(f.scrub=parseFloat(b)),i&&console.log("[gsap-init] ScrollTrigger config:",f),ScrollTrigger.create(f)}function i(e){function n(){q++,q+F===p&&(i(),d())}function s(e){F++,n()}function i(){var a=window.devicePixelRatio||1,t=e.clientWidth,r=Math.round(t/A);C.style.width=t+"px",C.style.height=r+"px",C.width=Math.round(t*a),C.height=Math.round(r*a),E.scale(a,a),l(M)}function l(e){var a=window.devicePixelRatio||1,t=C.width/a,r=C.height/a;if(E.clearRect(0,0,t,r),!b||2>p){var n=Math.max(0,Math.min(p-1,Math.round(e)));return void(T[n]&&T[n].complete&&E.drawImage(T[n],0,0,t,r))}var s=Math.max(0,Math.min(p-1,e)),i=Math.floor(s),l=Math.min(i+1,p-1),d=o(s-i,m/p);0===d||i===l?(E.globalAlpha=1,T[i]&&T[i].complete&&E.drawImage(T[i],0,0,t,r)):(T[i]&&T[i].complete&&(E.globalAlpha=1,E.drawImage(T[i],0,0,t,r)),T[l]&&T[l].complete&&(E.globalAlpha=d,E.drawImage(T[l],0,0,t,r))),E.globalAlpha=1}function d(){var a={frame:0};gsap.to(a,{frame:p-1,ease:"none",scrollTrigger:{trigger:e,start:y,end:h,scrub:f,markers:S,pin:!0,anticipatePin:1},onUpdate:function(){M=a.frame,l(a.frame)}})}var c=e.dataset,u=c.gsapCanvasSrc,p=parseInt(c.gsapCanvasFrames),v=parseInt(void 0!==c.gsapCanvasPad?c.gsapCanvasPad:g.canvas.pad),f=parseFloat(void 0!==c.gsapCanvasScrub?c.gsapCanvasScrub:g.canvas.scrub),b="true"===(void 0!==c.gsapCanvasFade?c.gsapCanvasFade:String(g.canvas.fade)),m=parseInt(void 0!==c.gsapCanvasFadeFrames?c.gsapCanvasFadeFrames:g.canvas.fadeFrames),y=r(void 0!==c.gsapCanvasStart?c.gsapCanvasStart:g.canvas.start),h=r(void 0!==c.gsapCanvasEnd?c.gsapCanvasEnd:g.canvas.end),S="true"===(c.gsapCanvasMarkers||"false");a(e,g.debugAttr)||null!==e.closest("[data-gsap-debug='true']");if(!u)return void t(e,"data-gsap-canvas-src es requerido");if(!p||isNaN(p))return void t(e,"data-gsap-canvas-frames es requerido");var w=void 0!==c.gsapCanvasRatio?c.gsapCanvasRatio:g.canvas.ratio,A=Function("return "+w)();e.style.display="flex",e.style.alignItems="center",e.style.justifyContent="center",e.style.overflow="hidden";var C=document.createElement("canvas");C.style.display="block",e.appendChild(C);for(var E=C.getContext("2d"),M=0,T=new Array(p),q=0,F=0,x=0;p>x;x++)!function(e){var a=new Image,t=String(e);if(v>0)for(;t.length<v;)t="0"+t;a.src=u.replace("{i}",t),a.onload=n,a.onerror=function(){s(e)},T[e]=a}(x);window.addEventListener("ibgsap:layout",function(){i(),ScrollTrigger.refresh()})}function o(e,a){return 0>=a?e>0?1:0:Math.min(1,e/a)}function l(e){var a=e.querySelectorAll("[data-gsap-depth]");if(0!==a.length){var t=r(void 0!==e.dataset.gsapStart?e.dataset.gsapStart:"top bottom"),n=r(void 0!==e.dataset.gsapEnd?e.dataset.gsapEnd:"bottom top"),s=e.dataset.gsapScrub;s=void 0===s||"true"===s?!0:"false"===s?!1:parseFloat(s)||!0;var i=gsap.timeline({scrollTrigger:{trigger:e,start:t,end:n,scrub:s}});a.forEach(function(e){var a=parseFloat(e.getAttribute("data-gsap-depth"))||0;i.fromTo(e,{y:0},{y:-300*a,ease:"none"},0)})}}function d(){if(!window.matchMedia("(prefers-reduced-motion: reduce)").matches&&!window.matchMedia("print").matches&&"undefined"!=typeof gsap&&"undefined"!=typeof ScrollTrigger){gsap.registerPlugin(ScrollTrigger);var e=function(){ScrollTrigger.refresh(),window.dispatchEvent(new CustomEvent("ibgsap:layout"))};window.addEventListener("resize",e);var a=document.querySelector('div[role="main"]')||document.body;window.ResizeObserver&&new ResizeObserver(e).observe(a);for(var t=document.querySelectorAll("[data-gsap-parallax]"),r=0;r<t.length;r++)l(t[r]);for(var n=document.querySelectorAll("[data-gsap-scene]"),o=0;o<n.length;o++){var d=n[o];d.style.userSelect="none",d.style.webkitUserSelect="none";for(var g=d.querySelectorAll(".position-absolute, .position-relative"),c=0;c<g.length;c++)g[c]!==d&&(g[c].style.pointerEvents="none");for(var u=d.querySelectorAll("img, a, button, .interactive, [class*='-bg'], [class*='-stat'], [class*='-title'], [class*='-label'], [class*='-desc']"),p=0;p<u.length;p++)u[p].style.pointerEvents="auto";s(d)}for(var v=document.querySelectorAll("[data-gsap-canvas]"),f=0;f<v.length;f++)i(v[f])}}var g={defaults:{start:"top 75%",end:"bottom 25%",scrub:!0,pin:!1,markers:!1,duration:.5,ease:"power2.out",position:">"},canvas:{ratio:"16/9",scrub:.5,fade:!1,fadeFrames:3,pad:0,start:"top top",end:"+=300%",markers:!1},debugAttr:"data-gsap-debug",errorStyle:"outline: 3px solid red; outline-offset: 4px;"};"loading"===document.readyState?document.addEventListener("DOMContentLoaded",d):d()}();